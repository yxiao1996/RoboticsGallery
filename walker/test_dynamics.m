...
q0 = [-pi/6, pi/2, pi/6, 0, 0, 0]; % upright state
...
[p1,p2,p3,dp1,dp2,dp3,ph,pe] = ...
    autoGen_kinematics(theta1,theta2,theta3,dtheta1,dtheta2,dtheta3,Lb,Ll,d);

xvals = [0 ph(1) pe(1) p3(1)];
yvals = [0 ph(2) pe(2) p3(2)];
...
for j = 2:length(t)
    ...
    function dq = f(t, q)
        ...
        [M11,M12,M13,M21,M22,M23,M31,M32,M33,f1,f2,f3] = ...
            autoGen_3lwalker_dynamics(q1,q2,q3,dq1,dq2,dq3,u1,u2,Mb,Ml,Lb,Ll,d,I,g);
        MM = [
            M11 M12 M13;
            M21 M22 M23;
            M31 M32 M33
